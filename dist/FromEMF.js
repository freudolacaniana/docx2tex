...
FromEMF.Parse = function (buff, genv) {
  ...
  while (true) {
    ...
    //else if(fnm=="SETMETARGN") {}
      ...
      if (ind == 0x80000000) {
        ...
        if (co.t == "b") {
          ...
          if (co.stl == 0) {
            ...
            throw co.stl + " e-test1";
          }
          gst.colr = co.clr;
        } else if (co.t == "p") {
          prms.strk = co.stl != 5;
          gst.lwidth = co.wid;
          gst.COLR = co.clr; //COLR-<colr
        } else if (co.t == "f") {
          prms.fnt = co;
          gst.font.Tf = co.nam;
      ...
      loff += 4;
      console.log("ind: " + ind); //
      console.log("tab[ind]: " + tab[ind]); //
      if (tab[ind] != null || tab[ind] == undefined) tab[ind] = null; //undefined追加
      else throw "e-deleteobject";
